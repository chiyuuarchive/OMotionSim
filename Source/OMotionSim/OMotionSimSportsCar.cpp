...
#include "OMotionSimSportsCar.h"
#include "OMotionSimSportsWheelFront.h"
#include "OMotionSimSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AOMotionSimSportsCar::AOMotionSimSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UOMotionSimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UOMotionSimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UOMotionSimSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UOMotionSimSportsWheelRear::StaticClass();
