...
#include "OMotionSimOffroadCar.h"
#include "OMotionSimOffroadWheelFront.h"
#include "OMotionSimOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AOMotionSimOffroadCar::AOMotionSimOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UOMotionSimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UOMotionSimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UOMotionSimOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UOMotionSimOffroadWheelRear::StaticClass();
